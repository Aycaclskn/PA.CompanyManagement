...
using PA.CompanyManagement.Core.Extenstions;
using System;
    ...
    public class AccountingDBContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            if(!optionsBuilder.IsConfigured)
                optionsBuilder.UseSqlServer("Server=127.0.0.1,1433;Database=AccountingDb;User Id=sa;Password=1;Encrypt=False");
#endif
